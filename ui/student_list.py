...
class StudentListPanel(ctk.CTkFrame):
    ...
    def _build(self):
        # Action bar (Add Event lives here in 5.4)
    ...
    def _rebuild_header(self):
        ...
        _header_label(self._header_frame, "Final", COL_FINAL)
    ...
    def _rebuild_rows(self):
        ...
        if not enrollments:
            ctk.CTkLabel(
                self._scroll,
                text="No students yet. Add one below.",
    ...
    def _build_row(self, enrollment, bg):
        ...
        try:
            ...
            final = None
        _cell(row, str(final) if final is not None else "—", COL_FINAL, bold=True)
